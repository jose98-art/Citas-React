...
const Formulario = ({pacientes, setPacientes, paciente, setPaciente}) => {
    ...
    useEffect(()=>{
       if(Object.keys(paciente).length > 0){//Object.keys -es un metodo de comprobar si un objeto tiene algo
  ...
  return (
    <div className="md:w-1/2 lg:w-2/5" >
        ...
        <form onSubmit={handlSubmit} className="bg-white shadow-md rounded-lg py-10 px-5 mb-10 mx-5">
